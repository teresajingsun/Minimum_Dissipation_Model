...
*/
    volScalarField 	r(max(-det(D),dimensionedScalar("r",dimensionSet(0, 0, -3, 0, 0, 0, 0), 1e-25)));
    volScalarField      q(max((1.0/2.0) * D && D, dimensionedScalar("q",dimensionSet(0, 0, -2, 0, 0, 0, 0), 1e-25)));	
