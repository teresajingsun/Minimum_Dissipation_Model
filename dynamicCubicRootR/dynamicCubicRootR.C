...
dynamicCubicRootR - Implementation of the dynamic Smagorinsky
                     SGS model.
...
void dynamicCubicRootR<BasicTurbulenceModel>::correctNut
(
...
)
{
    ...
    this->nut_ = max(cD_*sqr(this->delta())*pow(mag(-det(S)),1.0/3.0), -this->nu()+this->nu());
...
template<class BasicTurbulenceModel>
dynamicCubicRootR<BasicTurbulenceModel>::dynamicCubicRootR
(
...
template<class BasicTurbulenceModel>
void dynamicCubicRootR<BasicTurbulenceModel>::calcCD
(
...
)
{
    ...
    (
        sqr(this->delta())
       *(filter_((pow(mag(-det(S)),1.0/3.0))*(S)) - 4.0*pow(mag(filter_(-det(S))),1.0/3.0)*filter_(S))
    );
...
template<class BasicTurbulenceModel>
void dynamicCubicRootR<BasicTurbulenceModel>::calcCI
(
    const volSymmTensorField& S
)
{
...
template<class BasicTurbulenceModel>
bool dynamicCubicRootR<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void dynamicCubicRootR<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
