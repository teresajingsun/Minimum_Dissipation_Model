...
dynamicCubicRootRS - Implementation of the dynamic Smagorinsky
                     SGS model.
...
void dynamicCubicRootRS<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
dynamicCubicRootRS<BasicTurbulenceModel>::dynamicCubicRootRS
(
...
template<class BasicTurbulenceModel>
void dynamicCubicRootRS<BasicTurbulenceModel>::calcCD
(
...
)
{
    ...
    (
        sqr(this->delta())
       *(filter_((pow(mag(-det(S)),1.0/3.0))*(S)) - 4.0*mag(filter_(S))*filter_(S))
    );                                              
...
template<class BasicTurbulenceModel>
void dynamicCubicRootRS<BasicTurbulenceModel>::calcCI
(
    const volSymmTensorField& S
)
{
...
template<class BasicTurbulenceModel>
bool dynamicCubicRootRS<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void dynamicCubicRootRS<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
